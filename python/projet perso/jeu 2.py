...
def scene_2():
    afficher_texte_lentement("you wake up and see you're fall asleep, you're late you need to hurry up")
    afficher_texte_lentement("do you want to run? yes or not?")
    choose = str(input("yes or no?"))
    x = 0
    while  x < 3 :
        choose = str(input("yes or no?"))
        if choose =="yes":
